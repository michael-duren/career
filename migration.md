...
| 7.7   | `tests/workspace.integration.mjs`, `tests/journals.integration.mjs`, `tests/workspace.browser.mjs`, `tests/journals.browser.mjs`, `tests/pwa.browser.mjs`, `tests/dev-auth.test.mjs`, `scripts/test-auth.js`, `tests/go-api.integration.mjs`, `package.json`; keep `tests/workspace.test.ts`, `tests/timeline.test.ts`, `tests/search.test.ts`, `tests/journals.test.ts`, `tests/companies.test.ts`; deferred MCP files listed in 3.8.                             |
